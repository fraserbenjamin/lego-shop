  ...
  return (
    <footer className="bg-brand-purple text-white w-full px-12 flex flex-col py-8">
      ...
      <div className="flex flex-col place-items-start space-y-5">
        ...
        <div className="bg-[#18152d] flex space-x-3 px-3 py-2 place-items-center rounded-xs">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex">
              <input
                ...
                className="border border-white bg-white px-3 py-3 font-regular text-sm text-neutral-900"
              />
